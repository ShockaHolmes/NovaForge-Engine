...
## v0.6.0 - Pro World Builder Upgrade

Added a larger professional-style world building upgrade so NovaForge feels closer to a modern editor workflow.

### Added

- Better Environment generator with large sculpted terrain, water, forest, rocks, mountains, road/path, NPC, enemy, collectables, player, lighting, and camera follow.
- World Builder buttons for forest, rocks, water, road/path, mountains, day/night lighting, and weather.
- Weather system with clear, rain, snow, and embers particle modes.
- New object presets: NPC, Enemy, Collectable, Vehicle, Door, Trigger Zone, Tree, Rock, Water, Road, and Mountain.
- Starter templates: Adventure, Platformer, Racing, and Training Simulator.
- Prefab creation and prefab spawning from selected objects.
- Development profiler overlay showing FPS, object count, and mode.
- Console overlay for visible editor status/debug feedback.
- Save/load support for prefabs and environment state.
- Export manifest now lists world builder, terrain, weather, prefabs, templates, profiler, and console support.

### Notes

This is still a browser prototype, but the workflow now moves closer to Unity/Unreal/Godot-style development with scene creation, reusable prefabs, templates, gameplay mode, camera follow, and debugging tools.
